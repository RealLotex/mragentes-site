...
### 🖥️ Anthropic arma su propio silicio: contrata a Amir Salek, el creador de las 7 primeras generaciones del TPU de Google (antes 8 años en Nvidia), para su compute team — mientras Broadcom negocia un paquete de deuda de ~US$80.000M para financiar los chips de Anthropic
- **Fuente original:** Business Standard / Reuters (vía múltiples medios)
...
- **Por qué importa:** Anthropic confirmó el viernes 21/8 la incorporación de Amir Salek —quien dirigió el negocio de TPU de Google hasta 2022 y entregó las primeras 7 generaciones de esos chips, tras 8 años en Nvidia— a su compute team (reportará a James Bradbury), sumándose a Clive Chan, ex-miembro del equipo de chips custom de OpenAI contratado en junio; según Livemint, Broadcom negocia a la vez un paquete de deuda de ~US$80.000M para financiar la ambición de silicio de Anthropic, que hoy compra procesadores a Nvidia, Google y Amazon. Es el tercer movimiento de integración vertical de hardware de la semana (tras el chip custom de Waymo del 20/8, entrada de arriba, y el ASIC de OpenAI en Ohio): los vendors de IA construyen su propio cómputo para salir de la dependencia de Nvidia y controlar costos — financiado con deuda récord (Broadcom ya backstopeó el deal Big Sky de US$35.000M, entrada del 16/8). Para una PyME: el precio por token del futuro depende de quién controle el silicio, y la concentración vertical del proveedor refuerza la estrategia multi-modelo como gestión de riesgo de dependencia.
- **Fuentes de soporte (para la investigación profunda del domingo):**
  - Livemint (Broadcom US$80.000M en deuda para los chips de Anthropic): https://www.livemint.com/companies/news/broadcom-eyes-80-billion-debt-deal-to-fuel-anthropic-s-ai-chip-ambitions-11787405998684.html
  - CryptoBriefing (Amir Salek se suma a Anthropic): https://cryptobriefing.com/ex-google-amir-salek-joins-anthropic/
  - The Economic Times (equipo de semiconductores propio): https://economictimes.indiatimes.com/news/international/business/anthropic-hires-google-chip-veteran-amir-salek-as-part-of-push-into-hardware/articleshow/133430553.cms
  - explainx.ai (perfil de Salek y por qué importa): https://explainx.ai/blog/anthropic-hires-amir-salek-google-tpu-founder-chip-august-2026

### 🔎 Google lanza "Preferred Sources": los usuarios ahora eligen qué sitios priorizar en la Búsqueda y en los resúmenes de IA — el botón ya está activo y convertir a un cliente en "fuente preferida" pasa a valer tanto como el ranking
- **Fuente original:** Google (blog oficial) / Search Engine Journal
- **URL:** https://blog.google/products-and-platforms/products/search/personalize-search-discover-news/
- **Por qué importa:** Google anunció el jueves 20/8 un paquete de personalización en Search, Discover y News: el botón "Preferred Source" permite a cada usuario marcar los sitios que más confianza le generan para que aparezcan más seguido en los resultados y en las respuestas generadas por IA; además Discover se puede refinar escribiendo intereses específicos y la app de Google News en Android suma briefings de audio personalizados por tema. Es la primera vez que Google le da al lector una palanca directa sobre qué fuentes entran en los AI Overviews — el resumen que antes podía "enterrar" un link ahora puede priorizarlo si el lector pidió ese medio por nombre. Para una PyME: ganar el "pin" del cliente se vuelve una acción de marketing concreta y medible — pedir a los lectores/clientes que marquen el sitio como Preferred Source (el equivalente del "hit the bell" de YouTube en la era IA) es la vía más barata para aparecer en las respuestas de Gemini.
- **Fuentes de soporte (para la investigación profunda del domingo):**
  - Search Engine Journal (análisis de los 3 features): https://www.searchenginejournal.com/google-expands-personalization-across-search-discover-news/586528/
  - BetaNews (el botón como señal de confianza para publishers): https://betanews.com/article/google-now-lets-you-specific-the-sources-you-prefer-to-receive-news-and-results-from/
  - Business Today (anuncio del 20/8, relación directa publisher-lector): https://www.businesstoday.in/technology/news/story/google-adds-preferred-sources-to-search-and-other-personalisation-features-to-discover-and-news-giving-users-more-control-550496-2026-08-21

### 🎓 Anthropic abre Claude Academy: la "escuela de IA" gratuita con cursos oficiales sobre cómo trabajar con Claude (de fundamentos a agentes y Cowork) — el curso de delegación mapea directo a las decisiones de un equipo chico
- **Fuente original:** Anthropic (blog oficial + Claude Academy)
- **URL:** https://claude.com/blog/anthropics-approach-to-teaching-and-learning-ai
- **Por qué importa:** Anthropic lanzó el 20/8 Claude Academy (academy.claude.com, también accesible desde el tab "Learn more" del perfil de Claude): cursos y tutoriales gratuitos y abiertos a cualquiera, con rutas recomendadas, badges y un skill que sugiere caminos según cómo trabaja cada uno — el foco está en hábitos durables ("tratar al modelo de hoy como el peor que vas a usar nunca", "verificar en proporción a lo que está en juego") y buena parte del contenido es agnóstico de producto, no solo de Claude. El curso de delegación —qué dejarle a la IA y qué quedarse, con la regla de "redactar vos la parte sensible y dejar que la IA arme las slides de resumen"— es la decisión diaria de un negocio chico. Para una PyME: la capacitación oficial en IA de uno de los dos vendors dominantes ahora es gratis — el costo de subir la competencia del equipo (qué automatizar, qué supervisar) baja a cero, y es la señal de que los labs compiten también por la alfabetización de los usuarios, no solo por el precio por token.
- **Fuentes de soporte (para la investigación profunda del domingo):**
  - Claude Academy (plataforma oficial): https://academy.claude.com/
  - GIGAZINE (detalle de los cursos, del chat a los agentes): https://gigazine.net/news/20260821-anthropic-claude-academy/
  - DDay.it (análisis: "por fin Claude enseña a usar Claude"): https://www.dday.it/redazione/58434/claude-finalmente-insegna-agli-utenti-come-usare-claude-nasce-la-claude-academy-con-tutorial-e-corsi-gratis

### 🛍️ El 43% de los compradores ya compró algo que un chatbot de IA le recomendó (PartnerCentric, 696 shoppers): los que confían en IA son 5-6x más propensos a confiar en creadores, pero 44% exige reviews antes de actuar — la prueba concreta convierte la recomendación en venta
- **Fuente original:** PartnerCentric (estudio de compras de temporada) / NetInfluencer
- **URL:** https://hellopartner.com/ai-chatbot-creator-or-a-combo-of-the-two-who-do-shoppers-trust-on-the-path-to-purchase/
- **Por qué importa:** El estudio de la agencia PartnerCentric (696 compradores influenciados por IA + 319 creadores, difundido esta semana) encontró que el 43% compró en los últimos 3 meses un producto recomendado por un chatbot de IA (ChatGPT, Perplexity u otro rival) y que los shoppers que confían en IA tienen 5-6x más chances de confiar también en creadores (61% vs 11% del resto) — pero el 44% pide ver reviews antes de actuar sobre una recomendación y solo el 3% nombra el endorsement de un creador como driver principal: la prueba concreta es lo que convierte la recomendación en compra. Complementa el dato de Adobe ya anotado en la cola (tráfico de asistentes de IA al e-commerce +393% interanual) y el aviso de Tiendanube del 20/8: el asistente forma la decisión mucho antes del checkout, y los shoppers abren con IA (27%, cerca del 30% de Google) pero cierran en marketplaces. Para una PyME: la visibilidad en asistentes y las reviews verificables dejan de ser presupuestos separados — mantener los mismos claims y pruebas en la web, en creadores y en lo que el asistente puede citar es la jugada que convierte recomendación de IA en venta.
- **Fuentes de soporte (para la investigación profunda del domingo):**
  - NetInfluencer (cobertura del estudio): https://www.netinfluencer.com/shoppers-who-trust-ai-are-6x-more-likely-to-trust-creators-study-finds/
  - AIVO Journal (forecast: primera temporada decidida en la recomendación, no en el resultado de búsqueda): https://www.aivojournal.org/aivos-forecast-this-will-be-the-first-holiday-season-decided-at-the-recommendation-turn-not-the-search-result/
  - Forbes (qué dejan comprar a la IA: 42% elige compras bajo US$25): https://www.forbes.com/councils/forbestechcouncil/2026/08/18/what-consumers-will-actually-let-ai-buy-for-them/

### 💰 Anthropic apunta a igualar o superar el IPO récord de SpaceX (~US$86.000M): la mayor salida a bolsa de la historia sería de un laboratorio de IA, con filing público posible a fin de agosto
- **Fuente original:** Bloomberg (vía LA Times)
- **URL:** https://www.latimes.com/business/story/2026-08-21/anthropic-aims-to-match-spacex-with-record-shattering-ai-ipo
- **Por qué importa:** Bloomberg informó el 20/8 que Anthropic PBC espera igualar o superar el tamaño del IPO récord de SpaceX —que apuntó a US$75.000M y terminó levantando ~US$86.200M una vez ejercido el overallotment— y podría presentar su filing público ya a fin de este mes. Es la continuación directa de la saga de la cola (run rate >US$65.000M del 18/8, primer trimestre rentable del 15/8, Morgan Stanley/Goldman/JPMorgan liderando el listing de otoño) y, según Bloomberg, el año ya lleva US$160.600M levantados en IPOs hasta el 19/8 (vs US$195.200M en todo 2021): el debut de Anthropic lo pondría a la cabeza de la lista histórica. Para una PyME: el vendor de Claude deja de ser una startup financiada y pasa a ser una empresa pública con balances auditados — la estabilidad del proveedor de automatización se vuelve verificable, y la concentración del duopolio (89% de los ingresos de las startups de IA, entrada del 20/8) se consolida en el mercado de capitales.
- **Fuentes de soporte (para la investigación profunda del domingo):**
  - Bloomberg (dato original del 20/8): https://www.bloomberg.com/news/articles/2026-08-20/anthropic-expects-to-match-spacex-s-record-ipo-size-or-top-it
  - Benzinga (SpaceX: US$75.000M objetivo, ~US$86.200M final): https://www.benzinga.com/markets/private-markets/26/08/61345435/anthropic-is-coming-for-spacexs-86-billion-ipo-record
  - The Next Web (filing posible a fin de mes): https://thenextweb.com/news/anthropic-ipo-size-match-spacex-record
  - Yahoo Finance (US$160.600M en IPOs en 2026 hasta el 19/8): https://finance.yahoo.com/technology/ai/articles/anthropic-expects-match-spacex-record-175602035.html

### 💸 OpenAI recorta más de 20% el precio de GPT-5.6 Sol (API, créditos de Codex y ChatGPT Work) por 3 meses: el flagship frontier queda en US$4/US$20 por M tokens — el tercer recorte de la familia 5.6 tras Terra -20% y Luna -80%
- **Fuente original:** Reuters / OpenAI (anuncio oficial)
- **URL:** https://community.openai.com/t/20-price-reduction-for-gpt-5-6-sol-api-codex-credits-and-chatgpt-work/1391726
- **Por qué importa:** El viernes 21/8 OpenAI anunció que baja el precio de API y créditos de GPT-5.6 Sol —su modelo frontier de razonamiento— en más de 20% durante los próximos 3 meses: input a US$4 por M tokens y output a US$20 por M, aplicando también a créditos de Codex y planes elegibles de ChatGPT Work; OpenAI lo atribuye a eficiencia (costos de inferencia -20% y eficiencia de generación de tokens +15%), mientras Reuters lo lee como respuesta a la competencia de Anthropic y los modelos chinos — en línea con el dato de Ramp de la misma semana: Anthropic le arrebató a OpenAI el liderazgo en usuarios de negocio (41% vs 39%) y el ChatGPT maker no lo recuperó desde mayo. Para una PyME: el flagship del proveedor dominante baja de precio por un trimestre entero — el costo de automatizar razonamiento de alto nivel cae ~20% hoy, pero es un descuento temporal: la previsibilidad del precio por token sigue siendo el criterio de compra, y refuerza la estrategia multi-modelo (OpenRouter ya ofrecía 50% off en la ruta Sol desde el 17/8).
- **Fuentes de soporte (para la investigación profunda del domingo):**
  - Reuters vía 93.3 The Drive (anuncio del viernes 21/8): https://www.933thedrive.com/2026/08/21/openai-cuts-developer-pricing-for-frontier-gpt-5-6-sol-model-by-more-than-20/
  - Finimize (precios US$4/US$20 por M tokens): https://finimize.com/content/openai-cut-gpt-56-sol-api-prices-to-keep-developers-close
  - TechCrunch (Ramp: Anthropic 41% vs OpenAI 39% en usuarios de negocio): https://techcrunch.com/2026/08/20/openai-is-gaining-on-anthropic-with-business-users-new-data-indicates/
  - aipricing.guru (OpenRouter 50% off en Sol + costos de inferencia -20%): https://www.aipricing.guru/openai-pricing/

### ✍️ El 35% de las páginas web publicadas desde el lanzamiento de ChatGPT fueron escritas o editadas por IA (Pew Research): 490.000 páginas analizadas con Open Pangram — la escritura humana se vuelve un activo escaso
- **Fuente original:** Pew Research Center (vía Infobae)
- **URL:** https://www.pewresearch.org/data-labs/2026/08/20/how-much-of-the-internet-is-written-with-ai/
- **Por qué importa:** El Pew Research Center analizó 490.000 páginas en inglés del archivo Common Crawl (enero 2021 – julio 2026) con el detector Open Pangram: en la muestra completa, el 9,6% de las páginas muestra señales fuertes de autoría o edición por IA, pero si se filtra solo lo publicado desde noviembre de 2022 (el mes de ChatGPT), la cifra salta al 35% — más de un tercio de la web nueva ya no sale de manos humanas. La brecha sigue al modelo de negocio: 9,4% en dominios .com, 4,6% en .org, 1% en .edu y 0,8% en .gov (todos estaban por debajo del 1,1% antes de ChatGPT), y la huella lingüística es detectable: la raya larga casi se duplicó (de 5,79 a 11,19 apariciones por 10.000 palabras) y la coma de Oxford creció 63%. El contrapeso de Graphite/Axios: el 86% de los artículos que aparecen en resultados de Google sigue siendo de autoría humana, y los chatbots citan fuentes humanas en el 82% de los casos. Para una PyME: el contenido original y verificable deja de ser commodity y pasa a ser diferencial medible — el texto humano es el activo que los buscadores y los propios modelos siguen premiando, y automatizar redacción en volumen sin supervisión empuja a la web hacia la uniformidad sintética.
- **Fuentes de soporte (para la investigación profunda del domingo):**
  - Infobae (español, análisis de la brecha por dominio): https://www.infobae.com/estados-unidos/2026/08/21/internet-ya-no-se-escribe-solo-la-inteligencia-artificial-esta-detras-de-1-de-cada-3-textos-nuevos/
  - TechCrunch (un tercio de la web desde ChatGPT): https://techcrunch.com/2026/08/20/a-third-of-webpages-published-since-chatgpts-launch-show-signs-of-ai-authorship-study-finds/
  - Pew Research (metodología Open Pangram): https://www.pewresearch.org/data-labs/2026/08/20/methodology-ai-content/
  - CNET (dead internet theory): https://www.cnet.com/tech/services-and-software/dead-internet-theory-pew-research/

### 🚗 Waymo revela su primer chip custom: ASIC de 5nm fabricado por TSMC con más de 1.000 TOPS que ya corre en cada robotaxi (incluidos los nuevos Ojai) — el mayor operador de robotaxis diversifica su cadena de suministro más allá de Nvidia
- **Fuente original:** Waymo (blog oficial) / The Register
- **URL:** https://waymo.com/blog/2026/08/look-under-our-trunk/
- **Por qué importa:** En un post del 20-21/8, Waymo detalló por primera vez el chip que ya corre en todos sus robotaxis: un ASIC de 5 nanómetros fabricado por TSMC en el nodo automotriz N5A que entrega más de 1.000 TOPS para fusión de sensores en tiempo real —extrae información crítica de lidar, radar y cámaras, incluyendo denoising temporal para percepción con poca luz— con failover de doble chip; la compañía dice que su poder de cómputo se multiplicó 20x en ocho años. El chip no reemplaza a Nvidia (que sigue en el stack junto a AMD, Micron, Samsung y TSMC) sino que diversifica la cadena: hasta el mayor cliente de silicio para conducción autónoma quiere hardware propio, el mismo movimiento que Alphabet ya hizo en la nube con sus TPU. Para una PyME: la lección no es el robotaxi sino la estructura de costos del cómputo de IA — la integración vertical y el silicio custom presionan precios y disponibilidad de hardware, y depender de un único proveedor de cómputo (como de un único modelo) se vuelve el riesgo a gestionar.
- **Fuentes de soporte (para la investigación profunda del domingo):**
  - The Register (chip para adelantarse a Tesla, +1.000 TOPS): https://www.theregister.com/edge-and-iot/2026/08/20/waymo-has-designed-a-robocar-chip-to-stay-ahead-of-tesla/5290592
  - TechTimes (5nm TSMC N5A, specs completas en Hot Chips): https://www.techtimes.com/articles/325176/20260821/waymo-discloses-first-custom-chip-5nm-tsmc-automotive-silicon-every-robotaxi.htm
  - The Decoder (corte de dependencia de Nvidia): https://the-decoder.com/waymo-builds-its-own-chip-for-its-robotaxis-cutting-its-reliance-on-nvidia/
  - Yahoo Finance (contexto Alphabet): https://finance.yahoo.com/technology/ai/articles/alphabet-waymo-built-custom-chip-140000003.html
